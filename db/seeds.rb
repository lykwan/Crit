...
Availability.create!(event_id: 5, user_id: 1, date: DateTime.new(2016,10,13), time_slot_bitmap: 255)
Availability.create!(event_id: 5, user_id: 1, date: DateTime.new(2016,10,14), time_slot_bitmap: 255)
Availability.create!(event_id: 5, user_id: 1, date: DateTime.new(2016,10,15), time_slot_bitmap: 255)
Availability.create!(event_id: 5, user_id: 3, date: DateTime.new(2016,10,14), time_slot_bitmap: 255)
Availability.create!(event_id: 5, user_id: 3, date: DateTime.new(2016,10,15), time_slot_bitmap: 255)
Availability.create!(event_id: 5, user_id: 3, date: DateTime.new(2016,10,16), time_slot_bitmap: 255)

Availability.create!(event_id: 6, user_id: 6, date: DateTime.new(2016,11,2), time_slot_bitmap: 24435)
Availability.create!(event_id: 6, user_id: 6, date: DateTime.new(2016,11,3), time_slot_bitmap: 2235)
Availability.create!(event_id: 6, user_id: 6, date: DateTime.new(2016,11,5), time_slot_bitmap: 2343)
Availability.create!(event_id: 6, user_id: 6, date: DateTime.new(2016,11,7), time_slot_bitmap: 46533)
